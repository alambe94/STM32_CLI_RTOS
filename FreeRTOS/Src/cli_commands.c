...
CLI_Command_t xTaskStats =
		{ .CLI_Command = "task-stats", /* The command string to type. */
				...
				.CLI_Callback = Task_Stats_Callback, /* The function to run. */
		};
...
CLI_Command_t xRunTimeStats =
		{ .CLI_Command = "run-time-stats", /* The command string to type. */
				...
				.CLI_Callback = Run_Time_Stats_Callabck, /* The function to run. */
		};
#endif /* configGENERATE_RUN_TIME_STATS */
...
CLI_Command_t xQueryHeap =
		{ .CLI_Command = "query-heap",
				...
				.CLI_Callback = Get_Heap_Callback, /* The function to run. */
		};
...
CLI_Command_t xStartStopTrace =
		{ .CLI_Command = "trace",
				...
				.CLI_Callback = Start_Stop_Trace_Callback, /* The function to run. */
		};
