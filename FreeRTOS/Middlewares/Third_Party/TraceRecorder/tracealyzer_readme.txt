...
Changes, v4.2.3 -> v4.2.12

- Removed theoretical recursion in UserEvents (could never happen in practice).
- Better handling of invalid format strings in User Events.
