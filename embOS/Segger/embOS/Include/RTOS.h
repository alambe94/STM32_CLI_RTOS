...
//
  ...
  #define OS_DUMMY_STATEMENT() __asm("dsb")
#endif
...
*/
void OS_MallocLock  (void) OS_CODE_SECTION_ATTRIBUTE;
void OS_MallocUnlock(void) OS_CODE_SECTION_ATTRIBUTE;

/*********************************************************************
*
*       Compiler specific implementation for thread local storage
*/
#define OS_TASK_HAS_PTLS  (1)                                                                 // pTLS always in task structure, used to store the default _impure_ptr
...
void OS_TASK_SetContextExtensionTLS(struct _reent * pReentStruct) OS_CODE_SECTION_ATTRIBUTE;  // Initialize Thread Local Storage, OS_TLS.c, CPU specific
//
